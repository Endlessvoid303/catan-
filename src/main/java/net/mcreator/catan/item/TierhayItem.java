...
public class TierhayItem extends Item {
	public TierhayItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("tier 2: 20 hay"));
		list.add(new TextComponent("tier 3: 30 hay"));
		list.add(new TextComponent("tier 4: 40 hay"));
		list.add(new TextComponent("tier 5: 50 hay"));
	}
}
